...
function Card({  id, title, body: text, src, handleEdit,stars,handleDelete }) {
  const renderStars = () => {
    ...
    <div className="card">
      <div className="card__body">
        ...
        <div className="car__body-star mrgn-top10">
          {renderStars()}
          <p className="card__body-description mrgn-top20">{text}</p>
        </div>
        <button
        ...
        <button className="card__body-btn red-color mrgn-top20"
